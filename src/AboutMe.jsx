    ...
    <div>
        <div className="aboutme-container">
            ...
            <div className="aboutme-content">
                ...
                <p>I have a strong background in computer science and programming, and I am proficient in a variety of programming languages, including JavaScript, C++, and Python. I have also developed several software applications, including a web-based application for a local business.</p>
            </div>
        </div>
    </div>
    );
